...
const SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "c6", text: "Swimwear (if kids want to play in water at Lake Geneva nearby)", required: false },
      ...
      { id: "c9", text: "Hat (sun hat for day, beanie for cool nights)", required: false },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "t4", text: "Towels (bath + beach — not provided)", required: true },
...
const ACTIVITIES = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Lake Geneva Public Beach", desc: "30 min away. Great for the older kids (7 & 11). Bring swimwear, towels & sunscreen. Grab ice cream on the Riviera Dockyard afterward." },
