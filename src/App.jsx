...
const SUPPLY_SECTIONS = [
  { id: "individual", emoji: "🏕️", label: "Individual Items", note: "Each family brings their own — per-household supplies.",
    items: [
      { id: "tent",     name: "TENT",                    family: "prerna"  },
      { id: "tarp",     name: "TARP",                    family: "prerna"  },
      { id: "ropes",    name: "ROPES",                   family: ""        },
      { id: "tiki-ind", name: "TIKI LIGHT",              family: ""        },
      { id: "hooks",    name: "HOOKS FOR TENT",          family: "farzana" },
      { id: "hammer",   name: "HAMMER",                  family: "farzana" },
      { id: "bed",      name: "BED + BLOWER",            family: "all"     },
      { id: "torch",    name: "TORCH",                   family: "prerna"  },
      { id: "blanket",  name: "BLANKET + PILLOW",        family: ""        },
      { id: "bugrepel", name: "BUG REPELLANT",           family: "all"     },
      { id: "afterbite",name: "AFTER BITE",              family: ""        },
      { id: "flashlight",name:"FLASHLIGHT",              family: ""        },
      { id: "batteries",name: "BATTERIES",               family: ""        },
      { id: "umbrella", name: "UMBRELLA",                family: "upasha"  },
      { id: "chair",    name: "CHAIR",                   family: "prerna"  },
      { id: "water",    name: "WATER",                   family: "prerna"  },
    ],
  },
  { id: "lunch-dinner", emoji: "🍖", label: "Lunch / Dinner", note: "Main protein and dinner items.",
    items: [
      { id: "fish1",       name: "FISH 1 — POMPANO",         family: "upasha"  },
      { id: "fish2",       name: "FISH 2",                   family: "prerna"  },
      { id: "chicken",     name: "CHICKEN",                  family: "upasha"  },
      { id: "mutton",      name: "MUTTON",                   family: "upasha"  },
      { id: "veggies",     name: "VEGGIES",                  family: "upasha"  },
      { id: "shrimp",      name: "SHRIMP",                   family: "farzana" },
      { id: "paneer1",     name: "PANEER 1",                 family: "farzana" },
      { id: "paneer2",     name: "PANEER 2",                 family: ""        },
      { id: "biryani",     name: "Biryani [Chicken/Shrimp]", family: ""        },
      { id: "maggie",      name: "MAGGIE",                   family: ""        },
  ...
  { id: "breakfast", emoji: "🍳", label: "Breakfast", note: "Saturday morning spread.",
    items: [
      { id: "sausage",    name: "Sausage",         family: "farzana" },
      { id: "eggs",       name: "EGGS",            family: "prerna"  },
      { id: "shred-cheese",name:"Shredded CHEESE", family: "upasha"  },
      { id: "bread2",     name: "BREAD (2)",       family: "upasha"  },
      { id: "hashbrown",  name: "HASHBROWN",       family: "farzana" },
  ...
  { id: "common-nonfood", emoji: "🧹", label: "Common Items — Non Food", note: "Shared supplies and equipment.",
    items: [
      { id: "plates",    name: "PLATES",                 family: "prerna"  },
      { id: "cups",      name: "CUPS [Water & Tea]",     family: "prerna"  },
      { id: "tissues",   name: "TISSUES CleanX",         family: ""        },
      { id: "trashbag",  name: "TRASHBAG",               family: ""        },
      { id: "spoons",    name: "SPOON AND FORKS",        family: "farzana" },
      { id: "cutboard",  name: "CUTTING BOARD",          family: "farzana" },
      { id: "knife",     name: "KNIFE",                  family: "all"     },
      { id: "alfoil",    name: "ALUMINIUM FOIL (2)",     family: "prerna"  },
      { id: "ziplock",   name: "ZIPLOCK",                family: ""        },
      { id: "papertowel",name: "Paper Towel",            family: "all"     },
      { id: "tikifluid", name: "TIKI LIGHT FLUID",       family: ""        },
      { id: "dishsoap",  name: "Dish Soap And Brush",    family: ""        },
      { id: "strainer",  name: "Strainer",               family: "upasha"  },
      { id: "fogger",    name: "FOGGER",                 family: "prerna"  },
      { id: "tablecloth",name: "Table cloth",            family: "prerna"  },
      ...
      { id: "clingfoil", name: "Clingfoil",              family: ""        },
      { id: "bluetooth", name: "Bluetooth speaker",      family: ""        },
  ...
  { id: "snacks", emoji: "🍫", label: "Snacks & Condiments", note: "Drinks, snacks, and cooking basics.",
    items: [
      { id: "soda",       name: "SODA",                    family: "upasha"  },
      { id: "chips",      name: "Chips",                   family: "all"     },
      { id: "pitachips",  name: "PITA CHIPS",              family: ""        },
      { id: "fruits",     name: "FRUITS 1 2 3",            family: ""        },
      { id: "tea",        name: "TEA",                     family: "upasha"  },
      { id: "coffee",     name: "Coffee",                  family: "prerna"  },
      { id: "milk",       name: "MILK",                    family: "prerna"  },
      { id: "biscuits",   name: "BISCUITS",                family: ""        },
      { id: "sugar",      name: "SUGAR",                   family: ""        },
      { id: "salt",       name: "SALT",                    family: ""        },
      { id: "pepper",     name: "Pepper",                  family: "farzana" },
      { id: "spices",     name: "Spices",                  family: ""        },
      { id: "oil",        name: "OIL",                     family: "farzana" },
      { id: "butter",     name: "BUTTER",                  family: "upasha"  },
      { id: "ketchup",    name: "KETCHUP",                 family: "prerna"  },
      { id: "jam",        name: "JAM",                     family: "prerna"  },
      { id: "cheeseit",   name: "Cheese it",               family: ""        },
      { id: "fri-tea",    name: "Tea for friday evening",  family: ""        },
      { id: "watermelon", name: "Watermelon",              family: "farzana" },
      { id: "grapes",     name: "Grapes & strawberries",   family: "all"     },
    ],
  },
  ...
  { id: "dessert", emoji: "🔥", label: "Dessert & S'mores", note: "Sweet endings.",
    items: [
      { id: "brownies",    name: "Brownies",            family: "upasha"  },
      { id: "croissant",   name: "Chocolate Croissant", family: ""        },
...
export default function CampingChecklist() {
  ...
  const [familyNames, setFamilyNames] = useState(() => {
    try { return JSON.parse(localStorage.getItem("cc_familyNames")) || { farhana:"Farhana", upasha:"Upasha", farzana:"Farzana", prerna:"Prerna" }; }
    catch { return { farhana:"Farhana", upasha:"Upasha", farzana:"Farzana", prerna:"Prerna" }; }
  });
